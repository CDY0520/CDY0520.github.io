...
ORDER BY comm DESC NULLS LAST라고 명시하면,  
함수를 쓰지 않고도 깔끔하게 NULL을 꼴찌로 보낼 수 있다.  
<br>

옵션을 활용하는 이 방법은 SQL 표준에 가깝고,  
인덱스 성능에 영향을 주지 않아 훨씬 권장되는 해결책이다.  

<hr style="height: 5px; background-color: #777; border: none;">

## Note: 정렬은 가치 있는 정보를 맨 앞으로 끌어올리는 전략, NULL에 휘둘리지 말자.
